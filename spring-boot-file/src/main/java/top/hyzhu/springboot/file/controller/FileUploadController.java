package top.hyzhu.springboot.file.controller;
...
import top.hyzhu.springboot.file.utils.MinIoTemplate;
import top.hyzhu.springboot.file.utils.OssTemplate;
...
public class FileUploadController {
    ...
    public String minioUpload(MultipartFile file) {
        if (file != null) {
            ...
            try {
                url = minIoTemplate.putObject("zhy", "img/" + UUID.randomUUID() + suffixName, file.getInputStream());
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
            return url;
